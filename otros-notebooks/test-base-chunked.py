# -*- coding: utf-8 -*-
"""
Evaluación del modelo BASE Gemma-3 — usando TEST CHUNKED de HuggingFace
    → Comparación justa contra el modelo finetune
    → Versión rápida con batch inference (sin FastModel)
"""

print("📘 test-base-chunked-fast.py — Evaluación modelo BASE en test chunked (batch)")
...
JSONL_OUTPUT = "evaluacion_test_chunked_BASE_fast.jsonl"
...
print("Modelo BASE cargado en:", device)
...
print("🎉 Evaluación del modelo BASE (batch) COMPLETA.")
...
print("\n📊 Estadísticas globales del modelo BASE (batch):")
